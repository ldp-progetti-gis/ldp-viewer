...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	<head xml:lang="it">
		...
		<script type="text/javascript" src="{$GLOBALS['URLBaseInclude']}/LdpViewer/LdpMap.js?{$t}" defer></script>
		<script type="text/javascript" src="{$GLOBALS['URLBaseInclude']}/LdpViewer/LdpViewer.js?{$t}" defer></script>
		...
		<link rel="stylesheet" type="text/css" href="{$GLOBALS['URLBaseInclude']}/LdpViewer/LdpViewer.css?{$t}"/>
		
		{*CSS per responsive layout (media queries e altro) *}
		<link rel="stylesheet" type="text/css" href="{$GLOBALS['URLBaseInclude']}/LdpViewer/LdpViewer_responsive.css"/>
	...
	<body>
		{include file="{$GLOBALS['PATHBaseInclude']}/LdpViewer/LdpViewer.tpl" GLOBALS=$GLOBALS}
	</body>
</html>
