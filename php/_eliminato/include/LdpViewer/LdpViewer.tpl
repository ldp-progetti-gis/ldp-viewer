				...
				<div id="ov_info_tabs">
					<div id="ov_info_tabs_header">
						...
						<ul id="tabs">
							...
							{if isset($GLOBALS[$GLOBALS['package']]['tabs_view']['ov_link_custom']) && $GLOBALS[$GLOBALS['package']]['tabs_view']['ov_link_custom'] != true}
							{else}
								<li id="ov_link_custom"><a title="Torna al menu principale" class="ov_info_tabs">{"{$GLOBALS.PATHBaseInclude}/img/LdpViewer/toolbar/menu.svg"|file_get_contents}</a></li>
							{/if}
						</ul>
					</div>
