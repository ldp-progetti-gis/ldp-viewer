<?php
	...
	$GLOBALS['strings']['interface'] = array(
         ...
         'tab_custom_title'             => 'Info Mappa', // $PREFIX . 'Custom',
         ...
         'sentence_infofoundedlocation'         => 'Informazioni sulla posizione trovata',
         'sentence_insertscale'                 => 'Inserisci la scala desiderata e premi INVIO',
         'sentence_invalidurl'                  => 'URL non valido',
         'sentence_keepzoom'                    => 'Mantieni la scala corrente',
         ...
         'sentence_searchcityplaceaddress'      => 'Cerca un luogo, una località o un indirizzo',
         'sentence_searchbycoordinates'         => 'Ricerca la seguente posizione',
         'sentence_searchbytext'                => 'Ricerca il seguente indirizzo',
         'sentence_searchpage'                  => 'Pagina per la ricerca',
         'sentence_searchunsuccessful'          => 'Ricerca non riuscita',
         ...
         'sentence_typeaddressstring'           => 'Scrivi un indirizzo (esempio: via citt&agrave; nazione)',
         'sentence_typecoordinatex'             => 'Scrivi la coordinata X (lat, lon)',
         'sentence_typecoordinatey'             => 'Scrivi la coordinata Y (lat, lon)',
